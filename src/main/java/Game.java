public class Game {
    ...
    private void requirePreconditions(String trial) {
        require3Digits(trial);
        requireAllNumber(trial.toCharArray());
        requireNotDuplicatedNumber(trial.toCharArray());
    }
    ...
    private static void require3Digits(String digits) {
        if (digits.length() > 3)
